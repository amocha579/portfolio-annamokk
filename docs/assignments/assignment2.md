...
**Urban Kickstart:** For new grads in new cities
...
The app will display an interactive map of the city and its neighborhoods. Users can click on locations and see notes posted about transportation, housing, safety tips, and the best places to visit. Users can also write their own notes and upvote others. 
...
Users will be able to upvote and downvote a blog post or comment to inspire community-driven discussion, like Reddit. 
...
The app will give awards/badges to users who have completed certain challenges, similar to Leetcode. 

18) Profile Background

Users will be able to give a short, customizable background on their profile that may include age, school, etc. This information can be either publicly visible or hidden (like Hinge).

19) Report Users
    
Like Reddit, users who violate the code of language, content, or privacy can be reported.

20) Approximate Location Tracking

The social geocaching feature works best when accurate location is enabled, but users can use "approximate" location tracking instead for privacy. Quantifying "approximate" would be a future discussion, but perhaps this could mean within a 0.5-mile radius. 

**VSD Analysis**

- Stakeholders
    - The app is designed for new grads, but the plan doesn’t currently specify how long ago a person graduated, and whether it’s from undergrad, grad, trade school, etc. Because people finish school at all different ages, the app will not discriminate solely based on age. It’ll be based on trust and community-driven, like Reddit. A possible effect is that people of widely varying ages can be on the app (ie: ~20-year-olds to ~50-year-olds). However, I don’t envision this to be a downside. What unifies these groups is their recent history in school and the shared experience of moving to a new city. 
...
- Values
    - The app is designed to support local businesses through its rewards service. It also promotes exercise by incentivizing users to walk/explore the city. However, shops must already give permission to have their location publicly advertised on the app. Otherwise, they may get an unpredictable amount of customers or solicitors blocking their venue. (*Brainstorming credit: Israel Wong)
